...
describe('Fuzzy Text Matcher2', () => {
    it('Levenstein', () => {
        ...
        const results1 = matcher.matches2('ice cream cookies');
        const expected1 = [
            {id: 1, score: 2.00},
            {id: 2, score: 1 + 1/3},
            {id: 3, score: 1/3},
        ...
        const results2 = matcher.matches2('ice cream cone');
        const expected2 = [
            {id: 1, score: 3.00},
            {id: 2, score: 1 + 1/3},
            {id: 3, score: 1/3},
        ...
        const results3 = matcher.matches2('cookies');
        const expected3 = [
            {id: 3, score: 1/3},
            {id: 4, score: 1/3},
        ];
        ...
        const results4 = matcher.matches2('chocolate cookies');
        const expected4 = [
            {id: 4, score: 1.0},
            {id: 3, score: 1/3},
        ];
