...
describe('TokenSequence', () => {
  it('startsWith()', () => {
    ...
    assert.isTrue(sequence.startsWith([attributeChocolate.type]));
    assert.isTrue(
      sequence.startsWith([attributeChocolate.type, attributeDecaf.type])
    );
    assert.isTrue(
      sequence.startsWith([
  ...
  it('atEOS()', () => {
    ...
    const t2 = new TokenSequence([attributeChocolate, attributeDecaf]);
