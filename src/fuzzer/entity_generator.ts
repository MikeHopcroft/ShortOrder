import { AttributeInfo, ICatalog, Key, PID } from 'prix-fixe';

import { AttributeGenerator } from './attribute_generator';

import { EntityX, QuantityX } from './fuzzer';

import { aliasesFromOneItem, Random } from './utilities';
...
export class EntityGenerator {
  ...
  randomEntity(random: Random): EntityX {
    ...
    return new EntityX(quantity, attributes, key, alias);
  }
}
